...
plt.subplot(1,2,2)
plt.plot(statistics_completo['num_nodes'], statistics_completo['percentage_mean'], ls='--', label='Alto consumo')
...
plt.title('Probabilidade de recepção da constelação', fontsize=24)
...
for satelite in statistics_individual['sat'].unique():
    ...
    plt.plot(subset['num_nodes'], subset['percentage_mean'], label=f'Alto consumo - Satélite {satelite}', ls='--')
...
plt.title('Probabilidade de recepção para cada satélite individual', fontsize=24)
plt.legend(fontsize=20)
...
path ='../../resultados/simulacao_completa_meu_simulador/'
...
plt.subplot(1,2,2)
plt.plot(statistics_completo['num_nodes'], statistics_completo['percentage_mean'], ls='--', label='Consumo reduzido')
plt.fill_between(statistics_completo['num_nodes'], statistics_completo['percentage_mean'] + soma_completo, statistics_completo['percentage_mean'] - soma_completo, alpha= 0.3)
plt.title('Probabilidade de recepção da constelação', fontsize=24)
plt.ylim(0.17,1)
plt.legend(fontsize=20)
...
for satelite in statistics_individual['sat'].unique():
    subset = statistics_individual[statistics_individual['sat'] == satelite]
    soma_individual = 2.45*(subset['percentage_std']/np.sqrt(30))
    plt.plot(subset['num_nodes'], subset['percentage_mean'], label=f'Consumo reduzido - Satélite {satelite}', ls='--')
    plt.fill_between(subset['num_nodes'], subset['percentage_mean'] + soma_individual, subset['percentage_mean'] - soma_individual, alpha= 0.3)

plt.title('Probabilidade de recepção por satélite individual', fontsize=24)
plt.legend(fontsize=20)
plt.ylim(0.17,1)
plt.xlim(0,1.5e3)
plt.yscale("log")
