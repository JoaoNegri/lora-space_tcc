...
class Node():
    def __init__(self, nodeid: int, bs: int, avgSendTime: int, packetlen: int,
        ...
        self.packet = Packet(self.nodeid, packetlen, Ptx,
                             Prx, frequency, distance, num_sat)
        self.sent = 0
        ...
        self.header = Header(self.nodeid, self.ch, self.freqHop,
                             self.dr, Prx, Ptx, distance, num_sat)
        self.intraPacket = IntraPacket(
            self.nodeid, self.ch, self.freqHop, self.dr, Prx, Ptx, distance, num_sat)
